...
const SummaryPage = async (props: {
    ...
    const summary = await getPdfSummaryById(id);
    if (!summary) {
        notFound();
    }
        ...
        <div className="relative isolate min-h-screen bg-gradient-to-b from-rose-50/40 to-white">
            ...
            <div className="container mx-auto flex flex-col gap-4">
                <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-12 lg:py-24">
                    ...
                    <MotionDiv initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.5 }} className="relative mt-4 sm:mt-8 lg:mt-16 ">
                        ...
                        ">
                            <div className="absolute inset-0 bg-gradient-to-br from-rose-50/50
                            ...
                            <div className="absolute top-2 sm:top-4 right-2 sm:right-4 flex items-center
                                gap-1.5 sm:gap-2 text-xs sm:text-sm text-muted-foreground bg-white/90 px-3 sm:px-3 
