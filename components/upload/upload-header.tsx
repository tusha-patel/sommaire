...
const UploadHeader = () => {
    return (
        <div className="flex flex-col items-center text-center gap-4">
            <div className="relative p-[1px] overflow-hidden rounded-full bg-gradient-to-r from-rose-400 via-rose-500 to-rose-800 animate-gradient-x group cursor-pointer">
