...
import { scale, Variant } from 'motion/react'
...
const HeroSection = () => {
    return (
        <MotionSection variants={containerVariant} initial={"hidden"} animate={"visible"} className='relative mx-auto flex flex-col z-0 items-center  py-16 sm:py-20 lg:pb-28 transition-all animate-in lg:px-12 max-w-7xl'>
            ...
            <MotionH1 variants={itemVariants} className='font-bold py-6 text-center '>
                ...
                <span className='relative inline-block z-10 px-2'>concise
                    <MotionSpan whileHover={buttonVariants} className='absolute inset-0 bg-rose-200/50 -rotate-1 -z-10 rounded-lg transform -skew-y-1 ' aria-hidden="true"></MotionSpan>
                </span> summaries
            </MotionH1>
            <MotionH2 variants={itemVariants} className='text-lg sm:text-xl lg:text-2xl text-center px-4 lg:px-0 lg:max-w-4xl text-gray-600  '>Get a beautiful summary reel the dodument in seconds</MotionH2>
